...
const OrganizerDashboard: React.FC = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const [responseEvents, responseProfile] = await Promise.all([
        fetch("http://vibetribe-be-production.up.railway.app/api/v1/events/organizer?size=100", {
          method: "GET",
  ...
  const fetchStatistics = async () => {
    ...
    try {
      const response = await fetch("http://vibetribe-be-production.up.railway.app/api/v1/events/statistics", {
        method: "GET",
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const fetchTransactionHistory = async () => {
    ...
    try {
      const response = await fetch("http://vibetribe-be-production.up.railway.app/api/v1/events/transaction-history", {
        method: "GET",
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const fetchReviewsByOrganizer = async () => {
    ...
    try {
      const response = await fetch("http://vibetribe-be-production.up.railway.app/api/v1/reviews/by-organizer", {
        method: "GET",
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const fetchVouchers = async () => {
    ...
    try {
      const response = await fetch("http://vibetribe-be-production.up.railway.app/api/v1/vouchers/upcoming", {
        method: "GET",
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleVoucherSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("http://vibetribe-be-production.up.railway.app/api/v1/vouchers/create", {
        method: "POST",
        headers: {
  ...
  const handleUpdateProfile = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("http://vibetribe-be-production.up.railway.app/api/v1/user/update-profile", {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
        },
